...
const SCHICHTPLAN_FIELDS = [
  ...
  { key: 'schichttyp', label: 'Schichttyp', type: 'applookup/select', targetEntity: 'schichttypen', targetAppId: 'SCHICHTTYPEN', displayField: 'schichtname' },
  { key: 'zugewiesene_mitarbeiter', label: 'Zugewiesener Mitarbeiter', type: 'applookup/select', targetEntity: 'mitarbeiter', targetAppId: 'MITARBEITER', displayField: 'vorname' },
  { key: 'notizen', label: 'Notizen/Kommentare', type: 'string/textarea' },
];
...
export default function AdminPage() {
  ...
  const getApplookupDisplay = useCallback((entity: EntityKey, fieldKey: string, url?: unknown) => {
    ...
    if (entity === 'schichtplan' && fieldKey === 'schichttyp') {
      const match = (lists.schichttypenList ?? []).find((r: any) => r.record_id === id);
      return match?.fields.schichtname ?? '—';
    }
    if (entity === 'schichtplan' && fieldKey === 'zugewiesene_mitarbeiter') {
